...
#define WARP_SIZE 32
__global__ void jaccard_gpu2_kernel(CSRGraph* csrGraph_d, COOMatrix* cooMatrix_d, unsigned int* numCommonNeighbors, unsigned int* neighborsOfNeighbors){
...
void jaccard_gpu2(CSRGraph* csrGraph, CSRGraph* csrGraph_d, COOMatrix* cooMatrix_d) {
    ...
    jaccard_gpu2_kernel<<<numBlocks, numThreadsPerBlock>>>(csrGraph_d, cooMatrix_d, numCommonNeighbors, neighborsOfNeighbors);
